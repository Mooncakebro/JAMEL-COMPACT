...
class BrainWithExplicitMemory:
    ...
    def _parse_fields_from_raw_content(self, raw_content: str):
        field_list = [("thought", "--- Thought ---"), ("action", "--- Action ---"), ("updated_memory", "--- Updated Memory ---")]
    ...
    def decide_action(
        ...
        user_prompt = self.get_user_prompt(observation=observation, memory=memory_content, action_space=self.get_action_space())
