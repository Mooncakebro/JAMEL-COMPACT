set -x
ENGINE=${1:-vllm}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-'grpo_qwen3_vl_2b'_$(date +%m%d%H%M%S)}
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/data/tsz/modelscope_cache/models/Qwen/Qwen3-VL-2B-Instruct \
